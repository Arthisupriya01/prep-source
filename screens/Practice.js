    ...
    renderQuestions = qa => {
        return (
            <View style={{
                ...
                <TouchableOpacity onPress={() => this.setState({ ans: qa.option4 })}><Text>D. {qa.option4}{"\n"}</Text></TouchableOpacity>
                <TouchableOpacity onPress={() => this.setState({ ans: qa.option5 })}><Text>E. {qa.option5}{"\n"}</Text></TouchableOpacity>


                <Button
                    title="check"
                    onPress={() => {
                        if (this.state.ans === qa.answer) { this.setState({ totalScore: this.state.totalScore + 1, correct: true }) }
                        else {

                            this.setState({ correct: false })
                        }
                        this.setState({ ans: "", modalVisible: !this.state.modalVisible })
                    }}
                />
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={{ alignItems: 'center', justifyContent: 'center', fontSize: 15, fontWeight: '500', }}>Practice</Text>
                ...
                >
                    ...
                    <View style={{
                        ...
                        {this.state.correct ? <Text>Correct!!</Text> : <Text>Wrong!!</Text>}
                        <Button
                            title="close"
